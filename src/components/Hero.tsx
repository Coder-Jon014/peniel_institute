  ...
  return (
    <div className="flex flex-col md:flex-row justify-between items-center py-8 md:py-16 px-4 md:px-8 bg-white">
      <div className="w-full md:w-3/4 px-4 md:px-20 mb-8 md:mb-0 text-center md:text-left">
        ...
        <p className="text-sm md:text-base md:w-1/2 text-gray-500 mb-6">Affordable, Flexible, and Accessible Training Programs for Aspiring Leaders and Professionals.</p>
        <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
          <Button 
            className="w-full sm:w-auto bg-[#4B0082] hover:bg-[#3D0069] text-white flex items-center justify-center gap-2"
