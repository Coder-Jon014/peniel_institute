    ...
    <div className="flex flex-col md:flex-row justify-between items-center py-8 md:py-16 px-4 md:px-8 bg-white">
      ...
      <div className="w-full md:w-1/2 flex justify-center relative">
        ...
        <svg className="absolute top-0 left-0 w-full h-full" viewBox="0 0 800 800" xmlns="http://www.w3.org/2000/svg">
          <path d="M50,250 Q150,50 300,200 T600,150" fill="none" stroke="#4ADE80" strokeWidth="3" strokeLinecap="round" />
          <path d="M750,550 Q650,750 500,600 T200,650" fill="none" stroke="#4ADE80" strokeWidth="3" strokeLinecap="round" />
        </svg>
      </div>
    </div>
  );
